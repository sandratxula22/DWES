<?php
//Sandra Pico Álvarez
//Página para ver productos y añadir al carrito si clicamos añadir
...
function mostrarProductos($conn) {
    ...
    if (isset($_POST['submit']) && isset($_POST['id_categoria'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            <?php
            //si hay mensaje de error o éxito lo mostramos y despues lo eliminamos
